...
@Component({
  imports: [CurrencyPipe, MatDividerModule, MatChipsModule, RouterModule, MatProgressSpinnerModule, MatButtonModule, ProductGridComponent, CountdownComponent],
...
export class ProductViewComponent {
  ...
  constructor() {
    effect(() => {
      ...
      this.productsService.getProductsByCategory(this.category(), 3, this.productId())
        .pipe(takeUntilDestroyed(this.destroyRef)).subscribe((products) => {
